                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="provincia" name="provincia" value="<?php echo $user['provincia']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="canton">Cantón:</label>
                            <input type="text" class="form-control" id="canton" name="canton" value="<?php echo $user['canton']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="distrito">Distrito:</label>
                            <input type="text" class="form-control" id="distrito" name="distrito" value="<?php echo $user['distrito']; ?>" readonly>
                        </div>
                        <div class="form-group">
                            <label for="direccionDetallada">Dirección Detallada:</label>
                            <input type="text" class="form-control" id="direccionDetallada" name="direccion_detallada" value="<?php echo $user['direccion_detallada']; ?>" readonly>
                        </div>
                        <div class="form-group">
